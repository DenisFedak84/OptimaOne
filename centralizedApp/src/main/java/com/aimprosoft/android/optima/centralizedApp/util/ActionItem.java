...
public class ActionItem {
     ...
     *
     * @param sticky true for sticky, pop up sends com.optima.camScannerOptima.event but does not disappear
     */
    ...
    public ActionItemCallBack getCallBack() {
        return callBack;
    }

    public void setOnActionItemListener(ActionItemCallBack callBack) {
