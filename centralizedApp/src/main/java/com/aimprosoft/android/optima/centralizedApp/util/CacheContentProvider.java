...
public class CacheContentProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.aimprosoft.android.optima.centralizedApp.util.CacheContentProvider";
    public static final String CACHE_PATH = "cache";
    public static final String SCHEDULE_PATH = "schedule";

    public static final Uri CACHE_CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + CACHE_PATH);
    public static final Uri SCHEDULE_CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + SCHEDULE_PATH);

    static final String CACHE_CONTENT_TYPE = "vnd.android.cursor.dir/vnd." + AUTHORITY + "." + CACHE_PATH;
    static final String CACHE_CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd." + AUTHORITY + "." + CACHE_PATH;

    static final String SCHEDULE_CONTENT_TYPE = "vnd.android.cursor.dir/vnd." + AUTHORITY + "." + SCHEDULE_PATH;
    static final String SCHEDULE_CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd." + AUTHORITY + "." + SCHEDULE_PATH;
